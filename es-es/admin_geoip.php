...
$__LANG = array (
	...
	'desc_maintenance' => '',
	'tabcitylocations' => 'Ciudad (Sitios)',
	'tabcityblocks' => 'Ciudad (Bloque)',
	'generalinformation' => 'Información General',
	'indexsettings' => 'Configuracíon Indice',
	'rebuild' => 'Reconstruir',
	'taborganization' => 'Organización',
	'tabisp' => 'ISP',
	'tabnetspeed' => 'Netspeed',
	'geoiploadingalert' => 'Indexación en progreso. Por favor, no cambie de pagina, o la indexación se cancelará.',
	'entriesperpass' => 'Número de entradas a procesar por ciclo',
	'desc_entriesperpass' => 'Especificar el número de entradas a procesar en un ciclo. '. SWIFT_PRODUCT.' will iterate through all the entries one at a time, then rebuild the index for the loaded entries. A higher number requires a more powerful server. If you receive an error during process, try using a lower number.',
